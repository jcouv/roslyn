...
@"$$"));
        ...
        [Fact]
        public async Task TestAfterNestedAbstractPublicInInterface()
        {
            await VerifyKeywordAsync(
                """
                interface C {
        ...
        [Fact]
        public async Task TestAfterNestedPublicAbstractInInterface()
        {
            await VerifyKeywordAsync(
                """
                interface C {
        ...
        public async Task TestAfterClass()
            // TODO2
            => await VerifyKeywordAsync(@"class $$");
        ...
        [Fact]
        public async Task TestBetweenGlobalUsings_02()
        {
            // TODO2
            await VerifyKeywordAsync(
                """
        ...
        [Fact]
        public async Task TestInsideExtensionType()
        {
            await VerifyKeywordAsync("""
