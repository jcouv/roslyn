...
namespace Microsoft.CodeAnalysis.CSharp.Scripting.UnitTests
{
    ...
    {
        private static readonly string s_compilerVersionWithoutHash = CommonCompiler.GetInformationalVersionWithoutHash<CSharpInteractiveCompiler>();
        private static readonly string s_commitHash = CommonCompiler.GetCommitHash<CSharpInteractiveCompiler>();
