...
public class C
{
        ...
        where T : IEnumerable<U>
    {
        ...
        private static void CheckIteratorOverloading(string source, Func<MethodSymbol, bool> isDesiredOverload)
        {
            ...
            var guessedIterator = new CompilationContext(comp2, currentFrame: moveNextMethod, currentSourceMethod: moveNextMethod, locals: [], inScopeHoistedLocalSlots: [], inScopeLocalFunctions: [], methodDebugInfo: MethodDebugInfo<TypeSymbol, LocalSymbol>.None).
