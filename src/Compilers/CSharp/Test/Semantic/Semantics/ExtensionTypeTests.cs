...
// TODO2 emit references (such as base extensions, type arguments, method parameters, etc.)
// TODO2 re-hydrate from PE
// TODO2 test bad underlying types (dynamic, extension type or self or cycle, and other cases from IsRestrictedExtensionUnderlyingType)
// TODO2 test underlying types and base extensions containing dynamic, tuples, nullability
...
//Emit nullability stuff

// TODO2 test various cycles
// TODO2 test with conflicting extension marker methods (overloads)
// TODO2 test with marker method with ref parameters
// TODO2 test with marker method with zero parameter
// TODO2 test with instance marker method
// TODO2 test with extension method as marker method (with `this` parameter)
// TODO2 review every test in this file for additional PE checks
...
public class ExtensionTypeTests : CompilingTestBase
{
    ...
    private static void VerifyExtensionMarker(MethodSymbol markerMethod)
    {
        ...
        foreach (var parameter in markerMethod.Parameters)
        {
            ...
            Assert.Equal(NullableAnnotation.Oblivious, parameter.TypeWithAnnotations.NullableAnnotation); // TODO2 test with an extension in nullable context
...
""";
        ...
        static void validate(ModuleSymbol module)
        {
            ...
            {
                // TODO2 the order differs between source and metadata
                AssertEx.Equal(new[]
                    {
                        "System.Int32 R.StaticField", "System.String R.Const",
                        "void R.Method()", "void R.StaticMethod()",
            ...
            if (!inSource)
            {
                AssertEx.SetEqual(new[] { "IsByRefLikeAttribute", "ObsoleteAttribute", "DefaultMemberAttribute" },
...
""";
    ...
    {
        // TODO2 test missing IsByRefLikeAttribute (fail)
        var src = """
class C { }
...
";
    ...
    // TODO2 remove this test once issue below is resolved
    // TODO2 recognize the compiler feature flag (why isn't there an error already?)
    [Fact]
    ...
    extends [mscorlib]System.ValueType
{
    ...
    .custom instance void [mscorlib]System.ObsoleteAttribute::.ctor(string, bool) = (
        01 00 4e 45 78 74 65 6e 73 69 6f 6e 20 74 79 70
        65 73 20 72 65 66 65 72 65 6e 63 65 73 20 61 72
        65 20 6e 6f 74 20 73 75 70 70 6f 72 74 65 64 20
        69 6e 20 74 68 69 73 20 76 65 72 73 69 6f 6e 20
        6f 66 20 79 6f 75 72 20 63 6f 6d 70 69 6c 65 72
        2e 01 00 00
    )
...
""";
        ...
        var comp = CreateCompilationWithIL(src, ilSource);
        comp.VerifyDiagnostics(
            // (5,9): error CS0619: 'C.M()' is obsolete: 'Extension types references are not supported in this version of your compiler.'
            //         M();
            Diagnostic(ErrorCode.ERR_DeprecatedSymbolStr, "M()").WithArguments("C.M()", "Extension types references are not supported in this version of your compiler.").WithLocation(5, 9)
            );
    }
...
""";
        ...
        var comp = CreateCompilationWithIL(src, ilSource);
        comp.VerifyDiagnostics(
            // (5,13): error CS0619: 'C.field' is obsolete: 'Extension types references are not supported in this version of your compiler.'
            //         _ = field;
            Diagnostic(ErrorCode.ERR_DeprecatedSymbolStr, "field").WithArguments("C.field", "Extension types references are not supported in this version of your compiler.").WithLocation(5, 13)
            );
    }
...
""";
        ...
        var comp = CreateCompilationWithIL(src, ilSource);
        comp.VerifyDiagnostics(
            // (5,13): error CS0619: 'C.Property' is obsolete: 'Extension types references are not supported in this version of your compiler.'
            //         _ = Property;
            Diagnostic(ErrorCode.ERR_DeprecatedSymbolStr, "Property").WithArguments("C.Property", "Extension types references are not supported in this version of your compiler.").WithLocation(5, 13)
            );
    }
...
""";
        ...
        var comp = CreateCompilationWithIL(src, ilSource);
        comp.VerifyDiagnostics(
            // (5,9): error CS0619: 'C.Event' is obsolete: 'Extension types references are not supported in this version of your compiler.'
            //         Event += null;
            Diagnostic(ErrorCode.ERR_DeprecatedSymbolStr, "Event").WithArguments("C.Event", "Extension types references are not supported in this version of your compiler.").WithLocation(5, 9)
            );
    }
}
