...
";
        ...
        private static void TestDuplicateAssemblyAttributesNotEmitted(AssemblySymbol assembly, int expectedSrcAttrCount, int expectedDuplicateAttrCount, string attrTypeName)
        {
            ...
            var allEmittedAttrs = assembly.GetCustomAttributesToEmit(new ModuleCompilationState(), emittingRefAssembly: false, emittingAssemblyAttributesInNetModule: false);
        ...
        public void AssemblyAttributesFromNetModuleDropSpecial()
        {
            ...
            var attrs = consoleappCompilation.Assembly.GetCustomAttributesToEmit(new ModuleCompilationState(), emittingRefAssembly: false, emittingAssemblyAttributesInNetModule: false);
            foreach (var a in attrs)
            {
                switch (a.AttributeClass.Name)
                {
