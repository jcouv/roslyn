...
class C
{
    ...
    static async System.Threading.Tasks.Task Main()
    {
        ...
        // TODO: test disposing a completed state machine and trying to start it again or get a new enumerator
        // TODO: test using and lock (which are sugar for try/finally)
        // TODO: test method with a mix of different types getting awaited (we have one field per awaiter type)
