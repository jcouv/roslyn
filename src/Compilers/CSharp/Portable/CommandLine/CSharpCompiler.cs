            ...
            ImmutableArray<AnalyzerConfigOptionsResult> analyzerConfigOptions)
        {
            ...
            for (int i = 0; i < sourceFiles.Length; i++)
            {
                ...
                if (!uniqueFilePaths.Add(normalizedFilePath))
                {
                    ...
                    diagnostics.Add(new(MessageProvider, (int)ErrorCode.WRN_FileAlreadyIncluded,
            ...
            if (appConfigPath != null)
            {
                ...
                {
                    diagnostics.Add(new(MessageProvider, (int)ErrorCode.ERR_CantReadConfigFile, appConfigPath, ex.Message));
                }
            }
