...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class ContextualAttributeBinder : Binder
    {
        ...
        public ContextualAttributeBinder(Binder enclosing, Symbol symbol)
            : this(enclosing, symbol, GetAttributedMember(symbol))
        {
        }

        public ContextualAttributeBinder(Binder enclosing, Symbol attributeTarget, Symbol attributeMember)
             : base(enclosing, enclosing.Flags | BinderFlags.InContextualAttributeBinder)
        {
            _attributeTarget = attributeTarget;
            _attributedMember = attributeMember;
        }
