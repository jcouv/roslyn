...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal struct BestIndex
    {
        ...
        public static BestIndex None() { return new(BestIndexKind.None, 0, 0, 0); }
        public static BestIndex HasBest(int best) { return new(BestIndexKind.Best, best, 0, 0); }
        public static BestIndex IsAmbiguous(int ambig1, int ambig2) { return new(BestIndexKind.Ambiguous, 0, ambig1, ambig2); }
