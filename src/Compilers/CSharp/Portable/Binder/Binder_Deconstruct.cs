...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        private BoundExpression BindDeconstruction(AssignmentExpressionSyntax node, DiagnosticBag diagnostics)
        {
            ...
            var isDeclaration = node.IsDeconstructionDeclaration();
        ...
        internal BoundDeconstructionAssignmentOperator BindDeconstruction(CSharpSyntaxNode node, ExpressionSyntax left, ExpressionSyntax right,
                                                        DiagnosticBag diagnostics, bool isDeclaration, BoundDeconstructValuePlaceholder rightPlaceholder = null)
        {
        ...
        /// <summary>
        /// Checks that the expression doesn't contain any declaration expressions. The short-form of discard is allowed.
        /// </summary>
        ...
        /// For variables that are being declared, it makes locals (of fields in global statement).
        /// For expressions that don't declare variable, simply binds them and verify they are assignable to.
        /// The locals/fields/expressions are kept in a tree which captures the nesting of variables.
