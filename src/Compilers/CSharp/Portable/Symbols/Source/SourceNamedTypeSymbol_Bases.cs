...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal partial class SourceNamedTypeSymbol
    {
        ...
        protected override void CheckBase(DiagnosticBag diagnostics)
        {
            ...
            if (this.DeclaringCompilation.LanguageVersion < LanguageVersion.CSharp8 && this.IsGenericType && !localBase.IsErrorType() && this.DeclaringCompilation.IsAttributeType(localBase))
            {
