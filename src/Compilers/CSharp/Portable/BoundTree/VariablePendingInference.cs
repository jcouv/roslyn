        ...
        internal BoundExpression SetInferredType(TypeSymbolWithAnnotations type, Binder binderOpt, DiagnosticBag diagnosticsOpt)
        {
            ...
            switch (this.VariableSymbol.Kind)
            {
                case SymbolKind.Local:
                    ...
                    localSymbol.SetTypeSymbol(type);
                    return new BoundLocal(this.Syntax, localSymbol, isDeclaration: true, constantValueOpt: null, isNullableUnknown: false, type: type.TypeSymbol, hasErrors: this.HasErrors || inferenceFailed);
