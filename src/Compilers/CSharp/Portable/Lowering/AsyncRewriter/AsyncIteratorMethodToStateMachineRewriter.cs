...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class AsyncIteratorMethodToStateMachineRewriter : AsyncMethodToStateMachineRewriter
    {
        ...
        /// Wehn we enter a `try` that has an extracted `finally`, we will use the label preceeding the extracted `finally`.
        /// </summary>
        ...
        public override BoundNode VisitTryStatement(BoundTryStatement node)
        {
            ...
            // Note: we add this jump to extracted `finally` blocks as well, using a dedicated visitor.
