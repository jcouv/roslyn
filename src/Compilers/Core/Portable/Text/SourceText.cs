...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    public abstract class SourceText
    {
        ...
        private static readonly ObjectPool<char[]> s_charArrayPool = new ObjectPool<char[]>(static () => new char[CharBufferSize], CharBufferCount);
        private static readonly ObjectPool<XxHash128> s_contentHashPool = new ObjectPool<XxHash128>(static () => new XxHash128());
