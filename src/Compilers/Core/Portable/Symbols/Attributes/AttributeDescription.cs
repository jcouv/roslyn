...
namespace Microsoft.CodeAnalysis
{
    internal struct AttributeDescription
    {
        ...
        private static readonly byte[][] s_signaturesOfEnsuresTrueAttribute = { s_signature_HasThis_Void };
        private static readonly byte[][] s_signaturesOfEnsuresFalseAttribute = { s_signature_HasThis_Void };
        ...
        internal static readonly AttributeDescription EnsuresTrueAttribute = new AttributeDescription("System.Runtime.CompilerServices", "EnsuresTrueAttribute", s_signaturesOfEnsuresTrueAttribute);
        internal static readonly AttributeDescription EnsuresFalseAttribute = new AttributeDescription("System.Runtime.CompilerServices", "EnsuresFalseAttribute", s_signaturesOfEnsuresFalseAttribute);
