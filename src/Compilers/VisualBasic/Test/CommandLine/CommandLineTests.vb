...
Namespace Microsoft.CodeAnalysis.VisualBasic.CommandLine.UnitTests
    Partial Public Class CommandLineTests
        ...
        Private Shared ReadOnly s_compilerVersionWithoutHash As String = CommonCompiler.GetInformationalVersionWithoutHash(Of CommandLineTests)()
        Private Shared ReadOnly s_compilerShortCommitHash As String = CommonCompiler.ExtractShortCommitHash(CommonCompiler.GetInformationalVersionWithoutHash(Of CommandLineTests)())
