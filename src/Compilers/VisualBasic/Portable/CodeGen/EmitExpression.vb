    ...
    Partial Friend Class CodeGenerator
            ...
            Else
                ...
                ElseIf IsVerifierValue(receiverType) Then
                    ...
                    If IsVerifierValue(methodContainingType) AndAlso MayUseCallForStructMethod(method) Then
                        ...
                        Debug.Assert(TypeSymbol.Equals(receiverType, method.ContainingType, TypeCompareKind.ConsiderEverything2))
        ...
        Private Sub EmitTernaryConditionalExpression(expr As BoundTernaryConditionalExpression, used As Boolean)
            ...
            If (used) Then
                ...
                ElseIf (expr.Type.IsInterfaceType() AndAlso Not TypeSymbol.Equals(expr.Type, mergeTypeOfAlternative, TypeCompareKind.ConsiderEverything2) AndAlso Not TypeSymbol.Equals(expr.Type, mergeTypeOfConsequence, TypeCompareKind.ConsiderEverything2)) Then
                    EmitStaticCast(expr.Type, expr.Syntax)
                End If
            End If
        ...
        Private Sub EmitBinaryConditionalExpression(expr As BoundBinaryConditionalExpression, used As Boolean)
            ...
            Debug.Assert(TypeSymbol.Equals(expr.Type, expr.ElseExpression.Type, TypeCompareKind.ConsiderEverything2))
            ...
            If (used) Then
                ...
                ElseIf (expr.Type.IsInterfaceType() AndAlso Not TypeSymbol.Equals(expr.Type, mergeTypeOfLeftValue, TypeCompareKind.ConsiderEverything2) AndAlso Not TypeSymbol.Equals(expr.Type, mergeTypeOfRightValue, TypeCompareKind.ConsiderEverything2)) Then
                    EmitStaticCast(expr.Type, expr.Syntax)
                End If
            End If
        ...
        Private Shared Function IsVarianceCast(toType As TypeSymbol, fromType As TypeSymbol) As Boolean
            If (TypeSymbol.Equals(toType, fromType, TypeCompareKind.ConsiderEverything2)) Then
                Return False
            End If
            ...
            Return (toType.IsDelegateType() AndAlso Not TypeSymbol.Equals(toType, fromType, TypeCompareKind.ConsiderEverything2)) OrElse
        ...
        Private Sub EmitFieldInfoExpression(node As BoundFieldInfo, used As Boolean)
            ...
            If Not TypeSymbol.Equals(node.Type, getField.ReturnType, TypeCompareKind.ConsiderEverything2) Then
        ...
        Private Sub EmitMethodInfoExpression(node As BoundMethodInfo, used As Boolean)
            ...
            If Not TypeSymbol.Equals(node.Type, getMethod.ReturnType, TypeCompareKind.ConsiderEverything2) Then
                _builder.EmitOpCode(ILOpCode.Castclass)
                EmitSymbolToken(node.Type, node.Syntax)
            End If
