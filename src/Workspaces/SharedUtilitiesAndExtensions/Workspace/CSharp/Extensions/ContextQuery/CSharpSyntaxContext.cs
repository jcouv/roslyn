    ...
    public bool IsTypeAttributeContext(CancellationToken cancellationToken)
    {
        ...
        if (token.Kind() == SyntaxKind.OpenBracketToken &&
            ...
            this.SyntaxTree.IsTypeDeclarationContext(
                token.SpanStart, context: null, validModifiers: null, validTypeDeclarations: SyntaxKindSet.ClassInterfaceStructRecordExtensionTypeDeclarations, canBePartial: false, cancellationToken: cancellationToken))
        {
            return true;
        }
