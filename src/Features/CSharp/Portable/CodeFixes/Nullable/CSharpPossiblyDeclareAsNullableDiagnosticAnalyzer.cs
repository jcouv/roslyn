...
namespace Microsoft.CodeAnalysis.CSharp.CodeFixes.PossiblyDeclareAsNullable
{
    ...
    internal sealed class CSharpPossiblyDeclareAsNullableDiagnosticAnalyzer :
        DiagnosticAnalyzer
    {
        //internal static readonly DiagnosticDescriptor Hidden01 = new DiagnosticDescriptor(IDEDiagnosticIds.AddBracesDiagnosticId, "", "Throwing a diagnostic for #region", "", DiagnosticSeverity.Hidden, isEnabledByDefault: true);

        private static readonly DiagnosticDescriptor s_possiblyDeclareAsNullableRule = CreateDescriptor(
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => ImmutableArray.Create(s_possiblyDeclareAsNullableRule);
        ...
        //public CSharpPossiblyDeclareAsNullableDiagnosticAnalyzer()
