...
internal class UnsafeKeywordRecommender : AbstractSyntacticSingleKeywordRecommender
{
    ...
    protected override bool IsValidContext(int position, CSharpSyntaxContext context, CancellationToken cancellationToken)
    {
        ...
        return
            ...
            context.IsTypeDeclarationContext(validModifiers: s_validTypeModifiers, validTypeDeclarations: SyntaxKindSet.ClassInterfaceStructRecordExtensionTypeDeclarations, canBePartial: false, cancellationToken: cancellationToken) ||
