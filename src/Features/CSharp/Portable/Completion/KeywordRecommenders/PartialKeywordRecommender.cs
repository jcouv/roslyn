...
internal class PartialKeywordRecommender : AbstractSyntacticSingleKeywordRecommender
{
    ...
    {
        if (context.IsMemberDeclarationContext(validModifiers: s_validMemberModifiers, validTypeDeclarations: SyntaxKindSet.ClassInterfaceStructRecordExtensionTypeDeclarations, canBePartial: false, cancellationToken: cancellationToken))
        {
