...
internal class NewKeywordRecommender : AbstractSyntacticSingleKeywordRecommender
{
    ...
    {
        if (context.IsTypeDeclarationContext(validModifiers: ValidTypeModifiers, validTypeDeclarations: SyntaxKindSet.ClassInterfaceStructRecordExtensionTypeDeclarations, canBePartial: false, cancellationToken: cancellationToken))
        {
