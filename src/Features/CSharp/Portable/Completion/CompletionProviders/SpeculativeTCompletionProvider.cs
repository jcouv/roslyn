...
internal class SpeculativeTCompletionProvider : LSPCompletionProvider
{
    ...
    private static bool IsStartOfSpeculativeTContext(SyntaxTree syntaxTree, int position, CancellationToken cancellationToken)
    {
        ...
        return syntaxTree.IsMemberDeclarationContext(position, context: null, SyntaxKindSet.AllMemberModifiers, SyntaxKindSet.ClassInterfaceStructRecordExtensionTypeDeclarations, canBePartial: true, cancellationToken) ||
