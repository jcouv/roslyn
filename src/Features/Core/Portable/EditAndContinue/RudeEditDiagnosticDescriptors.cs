...
namespace Microsoft.CodeAnalysis.EditAndContinue
{
    ...
    internal static class RudeEditDiagnosticDescriptors
    {
        private static readonly ImmutableDictionary<RudeEditKind, DiagnosticDescriptor> s_descriptors = new List<KeyValuePair<RudeEditKind, DiagnosticDescriptor>>
        {
            ...
            { GetDescriptorPair(RudeEditKind.ExpressionVariablesInQueriesAndInitializersUpdate, FeaturesResources.Using_expression_variables_in_queries_or_initializers_will_prevent_the_debug_session_from_continuing) },
            { GetDescriptorPair(RudeEditKind.ConstructorInitializerUpdate,                      FeaturesResources.Updating_the_initializer_of_0_will_prevent_the_debug_session_from_continuing) },
